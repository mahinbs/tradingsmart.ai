...
const AiStockPrediction = () => {
    ...
    return (
        <div className="min-h-screen bg-black text-white font-sans selection:bg-cyan-500 selection:text-black overflow-x-hidden">
            ...
            <section id="offer" className="py-32 border-t border-white/5 bg-zinc-950/50 relative overflow-hidden">
            ...
            {/* 3. Supported Markets */}
            <section id="markets" className="py-32 bg-black relative">
            ...
            {/* 4. How the AI Works */}
            <section id="how-it-works" className="py-32 bg-zinc-950/30 relative overflow-hidden">
