  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans selection:bg-cyan-500 selection:text-black flex flex-col">
      <Helmet>
        ...
        <meta
          name="description"
          content="Read our latest insights on AI trading, market analysis, and strategies."
        />
      </Helmet>
        ...
        <div className="container mx-auto text-center relative z-10">
          <ScrollReveal>
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto font-light">
              Deep dives into AI prediction models, market sentiment, and quantitative trading
              strategies.
            </p>
          </ScrollReveal>
        </div>
      ...
      <section className="py-20 flex-1 relative">
        <div className="container mx-auto px-4 max-w-7xl">
          {isLoading ? (
            ...
            <div className="text-center text-gray-400">No articles published yet.</div>
          ) : (
