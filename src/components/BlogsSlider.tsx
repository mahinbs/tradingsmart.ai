        ...
        <section className="py-24 bg-zinc-950 overflow-hidden relative">
            ...
            <div className="container mx-auto px-4 mb-12 flex justify-between items-end relative z-10">
                ...
                <ScrollReveal delay={0.2} direction="left">
                    <Link to="/blogs" className="hidden sm:inline-flex items-center text-cyan-400 font-medium hover:text-cyan-300 transition-colors group">
                        View All Articles
            ...
            <div className="pl-4 md:pl-0">
                <div ref={sliderRef} className="keen-slider h-full pb-8">
                    {blogsData.concat(blogsData).map((blog, idx) => (
            ...
            <div className="container mx-auto px-4 mt-8 sm:hidden text-center">
                <Link to="/blogs" className="inline-flex items-center text-cyan-400 font-medium hover:text-cyan-300 transition-colors group">
                    View All Articles
                    <span className="ml-2 group-hover:translate-x-1 transition-transform">→</span>
                </Link>
            </div>
